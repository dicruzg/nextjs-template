...
const SingleVendor = () => {
    ...
    const id = Router.id; // Ensure you access query parameters correctly
    ...
    const handleOnClick = (index) => {
        setActiveIndex(index); // Set the active index without curly braces
    };
    ...
    return (
        <>
            <Layout headTitle="Blog" pageTitle="Our online News" pageTitleSub="The fancy moon going in little artist painting" parent="Blog" child="Blog Details" pageClass="front">
                        ...
                        <div className="container">
                            <div className="breadcrumb">
                                <ul>
                                    ...
                                    <li>
                                        <Link href="#">
                                            <span>Sony Digital Surround Wireless Headphones</span>
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div className="product-info">
                                            <div className="d-flex">
                                                ...
                                                <div className="box-rate-product">
                                                    <div className="box-rating">
                                                        <span>
                                                            <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" />
                                                        </span>
                                                        <span>
                                                            <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" />
                                                        </span>
                                                        ...
                                                        <span>
                                                            <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star.svg" />
                                                        </span>
                                                    </div>
                                            ...
                                            <div className="box-countdown mt-40">
                                                ...
                                                <div className="box-count">
                                                    <div className="deals-countdown pl-5" data-countdown="2026/05/25 00:00:00" />
                                                </div>
                                            </div>
                                            <div className="detail-extralink mb-30">
                                                <div className="detail-qty border radius">
                                                    ...
                                                    <input className="qty-val" name="quantity" defaultValue={1} min={1} />
                                                    <Link href="#">
                                                ...
                                                <div className="product-extra-link2">
                                                    <button className="button button-add-to-cart" type="submit">
                                                        <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/cart.svg" /> Add to cart
                                                    </button>
                                                    <Link href="#">
                                                        <span className="action-btn hover-up" aria-label="Add To Wishlist">
                                                            <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/heart.svg" />
                                                        </span>
                                                    </Link>
                                                    <Link href="#">
                                                        <span className="action-btn hover-up" aria-label="Compare"></span>
                                                    </Link>
                                                </div>
                                            </div>
                                            <div className="box-categories-link">
                                                <div className="item-cat">
                                                    ...
                                                    <Link href="#">
                                                        <span className="text-body-text color-gray-500">AgonMart</span>
                                                    </Link>
                                                </div>
                                                <div className="item-cat">
                                                    <span className="text-body-text color-gray-900">SKU:</span>
                                                    <Link href="#">
                                                        <span className="text-body-text color-gray-500">ABJK767C878</span>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="tab-content mt-50">
                                                    ...
                                                    <div className={activeIndex === 3 ? "tab-pane fade active show" : "tab-pane fade"}>
                                                        <div className="vendor-logo d-flex mb-30">
                                                            <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/vendor-18.svg" />
                                                        ...
                                                        <ul className="contact-infor mb-50">
                                                            <li>
                                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/icon-location.svg" />
                                                                <strong>Address: </strong>
                                                                <span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span>
                                                            </li>
                                                            <li>
                                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/icon-contact.svg" />
                                                        ...
                                                        <div className="comments-area">
                                                            <div className="row">
                                                                <div className="col-lg-8">
                                                                    ...
                                                                    <div className="comment-list">
                                                                        <div className="single-comment justify-content-between d-flex mb-30">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center">
                                                                                    <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-2.png" />
                                                                                    <Link href="#">
                                                                                ...
                                                                                <div className="desc">
                                                                                    <div className="d-flex justify-content-between mb-10">
                                                                                        <div className="d-flex align-items-center">
                                                                                            <span className="font-xs text-muted">December 4, 2026 at 3:12 pm</span>
                                                                                        </div>
                                                                                        <div className="product-rate d-inline-block">
                                                                        ...
                                                                        <div className="single-comment justify-content-between d-flex mb-30 ml-30">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center">
                                                                                    <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-3.png" />
                                                                                    <Link href="#">
                                                                                        <span className="font-heading text-brand">Brenna</span>
                                                                                    </Link>
                                                                                </div>
                                                                                <div className="desc">
                                                                                    <div className="d-flex justify-content-between mb-10">
                                                                        ...
                                                                        <div className="single-comment justify-content-between d-flex">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center">
                                                                                    <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-4.png" />
                                                                                    <Link href="#">
                                                                                        <span className="font-heading text-brand">Gemma</span>
                                                                                    </Link>
                                                                                </div>
                                                                                <div className="desc">
                                                                                    <div className="d-flex justify-content-between mb-10">
                                                                ...
                                                                <div className="col-lg-4">
                                                                    ...
                                                                    <Link href="#">
                                                                        <span className="font-xs text-muted">How are ratings calculated?</span>
                                                                    </Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp1.png" />
                                            </div>
                                            <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp2.png" />
                                            </div>
                                            <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp3.png" />
                                            </div>
                                            <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp4.png" />
                                            </div>
                                            <div className="product-info">
                                                <h3 className="title-product">Bass ultra x-203. Head phone</h3>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp5.png" />
                                            </div>
                                            <div className="product-info">
                                                <h3 className="title-product">Boxie by Dro C 3450. Active Noise</h3>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <span>
                                            <div className="product-image">
                                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp6.png" />
                                            </div>
                                            <div className="product-info">
                                                <h3 className="title-product">Sony DSC H300 - 20.1 Megapixel</h3>
                    ...
                    <div className="container">
                        <div className="box-green box-green-2 bdr-18">
                            ...
                            <div className="mt-60">
                                <Link href="#">
                                    <span className="mr-20">
                                        <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/apple-button.svg" />
                                    </span>
                                </Link>
                                <Link href="#">
                                    <span>
                                        <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" />
                                    </span>
                                </Link>
                            </div>
                            <div className="mt-10">
                            ...
                            <div className="block-1 d-none d-lg-block">
                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/safety.png" />
                            </div>
                            <div className="block-2 d-none d-lg-block">
                                <Image width="0" height="0" sizes="100vw" alt="agon" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/chart.png" />
                            </div>
                        </div>
                    </div>
                </section>
