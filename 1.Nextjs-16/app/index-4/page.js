						...
						<div className="container">
							<div className="row">
								<div className="col-lg-7">
									...
									<div className="mt-40">
										<Link href="/page-about-1" className="btn btn-pink icon-arrow-right-white text-heading-6">Get Start
										</Link>
										<Link href="/page-contact" className="btn btn-link color-white text-heading-6 btn-link-inter">Learn More
										</Link>
									</div>
									<div className="mt-60">
										<div className="row">
								...
								<div className="col-lg-5 d-none d-lg-block">
									<div className="banner-imgs">
										...
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-responsive shape-2" alt="Agon" src="/assets/imgs/page/homepage4/banner.png" />
									</div>
								</div>
							</div>
						</div>
							...
							<div className="col-lg-3 col-md-12 col-sm-12 mt-50">
								<div className="list-icons">
									<div className="item-icon pl-0">
										<div className="mb-15"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-acquis.svg" alt="Agon" /></div>
								...
								<div className="list-icons">
									<div className="item-icon pl-0">
										<div className="mb-15"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-active.svg" alt="Agon" /></div>
								...
								<div className="list-icons">
									<div className="item-icon pl-0">
										<div className="mb-15"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-retent.svg" alt="Agon" /></div>
					...
					<div className="container mt-90">
						<div className="row">
							<div className="col-lg-6 col-sm-12 block-img-we-do">
								<div className="inner-image"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-2.png" alt="Agon" /></div>
							</div>
							<div className="col-lg-6 col-sm-12 block-we-do-2"><span className="tag-1 color-orange-900">What We Do, What You Get</span>
								...
								<div className="list-icons mt-50">
									<div className="item-icon none-bd hover-up"><span className="icon-left"><Image
										width="0"
										height="0"
										sizes="100vw"
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-30"><span className="tag-1 bg-9 color-gray-900">Built Exclusively For You</span>
								...
								<div className="mt-40">
									<Link href="/page-about-1" className="btn btn-default btn-white icon-arrow-right">Learn More
									</Link>
								</div>
							</div>
							<div className="col-lg-7">
						...
						<div className="row">
							<div className="col-lg-6 col-sm-12">
								<div className="bg-2 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
									...
									<div className="box-image-inner bg-color-1"><Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/temp-1.png" alt="Agon" /></div>
								</div>
							</div>
							<div className="col-lg-6 col-sm-12">
								<div className="bg-6 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
									...
									<p className="text-body-text-md color-gray-600">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
									<div className="box-image-inner bg-color-2"><Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/temp-2.png" alt="Agon" /></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-lg-4 text-lg-end text-start pt-30">
								<Link href="/blog-1" className="btn btn-black icon-arrow-right-white">View More
								</Link>
							</div>
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Company</span>
									<Link href="/blog-single" className="text-heading-4">We can blend colors multiple ways, the most common
									</Link>
							...
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
									<Link href="/blog-single" className="text-heading-4">How To Blow Through Capital At An Incredible Rate
									</Link>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-2.png" alt="Agon" />
										</Link>
									</div>
								</div >
							</div >
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
									<Link href="/blog-single" className="text-heading-4">Design Studios That Everyone Should Know About?
									</Link>
									...
									<div className="grid-4-img color-bg-4">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-3.png" alt="Agon" />
										</Link>
									</div>
								</div >
							</div >
