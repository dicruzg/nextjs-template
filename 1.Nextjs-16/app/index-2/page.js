							...
							<div className="container">
								<div className="row">
									<div className="col-lg-7 mt-50">
										...
										<div className="mt-40">
											<Link href="/page-about-1" className="btn btn-black shape-square icon-arrow-right-white">Get Start
											</Link>
											<Link href="/page-about-2" className="btn btn-link icon-triangle color-gray-900 ml-40">How it works
											</Link>
										...
										<div className="banner-imgs">
											<div className="block-1 shape-2">
												<Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/balance.png" alt="Agon" />
											</div>
											<div className="block-2 shape-3">
												<Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/payment.png" alt="Agon" />
											</div>
											<Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="img-responsive shape-1" alt="Agon" src="/assets/imgs/page/homepage2/banner.png" />
										</div>
									</div>
								</div>
							</div>
									...
									<ul className="list-partners">
										<li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-1.svg" />
											</Link>
										</li>                                        <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-2.svg" />
											</Link>
										</li>                                        <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-3.svg" />
											</Link>
										</li>                                        <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-4.svg" />
											</Link>
										</li>                                        <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-5.svg" />
											</Link>
										</li>                                        <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-6.svg" />
											</Link>
										</li > <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-7.svg" />
											</Link>
										</li > <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-8.svg" />
											</Link>
										</li > <li>
											<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-9.svg" />
											</Link>
										</li >                                    </ul >
								</div >
							</div >
								...
								<div className="col-lg-6 col-sm-12 block-img-we-do">
									<div className="inner-image">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-2.png" alt="Agon" />
										<div className="block-chart">
											<Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/chart.png" alt="Agon" />
										</div>
									</div>
								</div>
								<div className="col-lg-6 col-sm-12 block-we-do-2">
									...
									<div className="list-icons mt-50">
										<div className="item-icon none-bd">
											<span className="icon-left"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-work.svg" alt="Agon" /></span>
										...
										<div className="item-icon none-bd">
											<span className="icon-left"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-design.svg" alt="Agon" /></span>
											<h4 className="text-heading-4">
										...
										<div className="item-icon none-bd">
											<span className="icon-left"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-advance.svg" alt="Agon" /></span>
											<h4 className="text-heading-4">
												Advanced analytics to grow your business
											</h4>
											<p className="text-body-excerpt color-gray-600 mt-15">
									...
									<div className="bg-2 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
										...
										<div className="box-image-inner bg-color-1">
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/temp-1.png" alt="Agon" />
										</div>
									</div>
								</div>
								<div className="col-lg-6 col-sm-12">
									<div className="bg-6 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
										...
										<div className="box-image-inner bg-color-2">
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/temp-2.png" alt="Agon" />
										</div>
									</div>
								</div>
							</div>
									...
									<div className="list-icons mt-50">
										<div className="item-icon">
											<span className="icon-left"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-acquis.svg" alt="Agon" /></span>
											<h4 className="text-heading-4">
												1. Acquisition
											</h4>
									...
									<div className="list-icons mt-50">
										<div className="item-icon">
											<span className="icon-left"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-active.svg" alt="Agon" /></span>
											<h4 className="text-heading-4">
												2. Activation
											</h4>
											<p className="text-body-text color-gray-600 mt-15">
									...
									<div className="list-icons mt-50">
										<div className="item-icon">
											<span className="icon-left"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/icon-retent.svg" alt="Agon" /></span>
								...
								<div className="col-lg-6 col-sm-12 block-we-do">
									<div className="inner-image">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-built.png" alt="Agon" />
										<div className="block-image-bottom">
											<Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-built-2.png" alt="Agon" />
										</div>
									</div>
								</div>
							</div>
												...
												<div className="box-img-user">
													<div className="img-user">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-1.png" alt="Agon" />
													</div>
												...
												<div className="box-img-user">
													<div className="img-user">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-2.png" alt="Agon" />
													</div>
													<h4 className="text-body-lead color-gray-900 mb-5">
														Wade Warren
													</h4>
												...
												<div className="box-img-user">
													<div className="img-user">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-3.png" alt="Agon" />
													</div>
													<h4 className="text-body-lead color-gray-900 mb-5">
														Leslie Alexander
													</h4>
												...
												<div className="box-img-user">
													<div className="img-user">
														<Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-4.png" alt="Agon" />
													</div>
													<h4 className="text-body-lead color-gray-900 mb-5">
														Jenny Wilson
													</h4>
									...
									<div className="bg-6 box-newsletter position-relative">
										<div className="row">
											<div className="col-lg-5 col-md-7">
												...
												<Link href="/page-terms" >Term and Conditions
												</Link>
