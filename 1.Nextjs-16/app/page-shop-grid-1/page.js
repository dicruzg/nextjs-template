                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 text-end">
                                <Link href="/page-signup" className="btn btn-default hover-up icon-arrow-right mt-10">
                                    Browse All
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/pc.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/headphone.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/laptop.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mobile.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/printer.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/book.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/tablet.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/usb.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mouse.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/security.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/watch.svg" alt="agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                <div className="category-grid-3 hover-up">
                                    <div className="category-img">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/scan.svg" alt="agon" />
                                        </Link>
                                    </div>
                ...
                <section className="section-box mt-90">
                    ...
                    <div className="container mt-70">
                                ...
                                <div className="icon-layout mr-10 text-body-text color-gray-500">
                                    ...
                                    <div className="color-green-900 d-inline">
                                        <div className="dropdown dropdown-sort">
                                            <button className="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static">
                                                <span>50</span>
                                        ...
                                        <div className="product-info">
                                            ...
                                            <div className="rating mt-10">
                                                <div className="box-rating">
                                                    <span></span>
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                    <span></span>
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                    <span></span>
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                        ...
                        <div className="paginations">
                            <ul className="pager">
                                <li>
                                    <Link href="#" className="prev-page"></Link>
                                </li>
                                <li>
                                    <Link href="#">1</Link>
                                </li>
                                ...
                                <li>
                                    <Link href="#" className="page-dotted"></Link>
                                </li>
                                <li>
                                    <Link href="#" className="next-page"></Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp1.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp2.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp3.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp4.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                                            <h3 className="title-product">Bass ultra x-203. Head phone</h3>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp5.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                                            <h3 className="title-product">Boxie by Dro C 3450. Active Noise</h3>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                                <div className="product-item-1 hover-up">
                                    <Link href="#">
                                        <div className="product-image">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp6.png" alt="agon" />
                                        </div>
                                        <div className="product-info">
                                            <h3 className="title-product">Sony DSC H300 - 20.1 Megapixel</h3>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                                <div className="card-grid-style-4">
                                    <div className="grid-4-img color-bg-9 mb-20">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img.png" alt="Agon" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                                <div className="card-grid-style-4">
                                    <div className="grid-4-img color-bg-2 mb-20">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-2.png" alt="Agon" />
                                        </Link>
                                    </div>
                                    <Link href="#" className="text-heading-4">
                                        We can blend colors multiple ways, the most common
                                    ...
                                    <div className="blog-img-user">
                                        <div className="img-user img-user-round">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-2.png" alt="Agon" />
                                        </div>
                                        <h4 className="text-heading-6 color-gray-900">Jenny Wilson</h4>
                                        <p className="text-body-small color-gray-500">August 25, 2026</p>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                <div className="card-list-style-1">
                                    ...
                                    <div className="blog-img-user">
                                        <div className="img-user img-user-round">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-3.png" alt="Agon" />
                                        </div>
                                    ...
                                    <div className="style-1-img color-bg-10">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-3.png" alt="Agon" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="card-list-style-1">
                                    ...
                                    <div className="blog-img-user">
                                        <div className="img-user img-user-round">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-4.png" alt="Agon" />
                                        </div>
                                    ...
                                    <div className="style-1-img color-bg-2">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-4.png" alt="Agon" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="card-list-style-1">
                                    ...
                                    <div className="blog-img-user">
                                        <div className="img-user img-user-round">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-5.png" alt="Agon" />
                                        </div>
                                    ...
                                    <div className="style-1-img color-bg-5">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-5.png" alt="Agon" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="card-list-style-1">
                                    ...
                                    <div className="blog-img-user">
                                        <div className="img-user img-user-round">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-6.png" alt="Agon" />
                                        </div>
                                    ...
                                    <div className="style-1-img color-bg-9">
                                        <Link href="#">
                                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-6.png" alt="Agon" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="box-green box-green-2 bdr-18">
                            ...
                            <div className="mt-60">
                                <Link href="#" className="mr-20">
                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/apple-button.svg" alt="agon" />
                                </Link>

                                <Link href="#">
                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" alt="agon" />
                                </Link>
                            </div>
                            <div className="mt-10">
                            ...
                            <div className="block-1 d-none d-lg-block">
                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/safety.png" alt="agon" />
                            </div>
                            <div className="block-2 d-none d-lg-block">
                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/chart.png" alt="agon" />
                            </div>
                        </div>
                    </div>
                </section>
