						...
						<div className="container">
							<div className="row">
								<div className="col-lg-6 box-banner-left"><span className="tag-1 bg-6 color-green-900">What We Do, What You Get</span>
									...
									<div className="mt-40">
										<Link href="/page-about-1" className="btn btn-black shape-square icon-arrow-right-white">Join Our Team</Link>

										<Link href="/page-contact" className="btn btn-link color-gray-900 icon-arrow-right text-heading-6">Contact Us</Link>
									</div>
								</div>
								<div className="col-lg-6 d-none d-lg-block">
									<div className="banner-imgs">
										<div className="block-1 shape-2"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/banner.png" alt="Agon" /></div>
										<div className="float-end col-lg-6 mt-90">
											<div className="list-icons mt-50">
												<div className="item-icon none-bd"><span className="icon-left"><Image
													width="0"
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-project-done.svg" alt="Agon" /></span>
												...
												<div className="item-icon none-bd"><span className="icon-left"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-officer.svg" alt="Agon" /></span>
												...
												<div className="item-icon none-bd"><span className="icon-left"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-constant.svg" alt="Agon" /></span>
								...
								<ul className="list-steps">
									<li className="icon-asset1 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
										<div className="text-center block-step">
											<div className="mb-30"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-start-plan.svg" alt="Agon" /></div>
									...
									<li className="icon-asset2 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
										<div className="text-center block-step">
											<div className="mb-30"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-connect.svg" alt="Agon" /></div>
									...
									<li className="icon-asset3 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
										<div className="text-center block-step bg-5">
											<div className="mb-30"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-match.svg" alt="Agon" /></div>
									...
									<li className="icon-asset4 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
										<div className="text-center block-step bg-5">
											<div className="mb-30"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-complete.svg" alt="Agon" /></div>
									...
									<li className="wow animate__animated animate__fadeIn" data-wow-delay=".7s">
										<div className="text-center block-step bg-9">
											<div className="mb-30"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-review.svg" alt="Agon" /></div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-6 col-sm-12 col-12 block-gallery-1">
								<div className="row">
									<div className="col-lg-6"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive mb-10" src="/assets/imgs/page/about/2/img-2.png" alt="Agon" /><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/about/2/img-3.png" alt="Agon" /></div>
									<div className="col-lg-6"><Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/about/2/img-1.png" alt="Agon" /></div>
								</div>
							</div>
							<div className="col-lg-6 col-sm-12 col-12 block-pl">
								...
								<div className="mt-30">
									<Link href="/page-service-2" className="btn btn-black text-body-text">Keep Reading</Link>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="container mt-100">
						<div className="row">
							...
							<div className="col-lg-4 text-lg-end text-start pt-30">
								<Link href="/page-service-1" className="btn btn-black icon-arrow-right-white">View More</Link>
							</div>
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Company</span>
									<Link href="/blog-single" className="text-heading-4">We can blend colors multiple ways, the most common</Link>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-1.png" alt="Agon" /></Link>
									</div>
								</div>
							</div>
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
									<Link href="/blog-single" className="text-heading-4">How To Blow Through Capital At An Incredible Rate</Link>
							...
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
									<Link href="/blog-single" className="text-heading-4">Design Studios That Everyone Should Know About?</Link>
								...
								<div className="card-grid-style-4"><span className="tag-dot">Company</span>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-4.png" alt="Agon" /></Link>
									</div>
								</div >
							</div >
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-5.png" alt="Agon" /></Link>
									</div>
								</div >
							</div >
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
									...
									<div className="grid-4-img color-bg-4">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-6.png" alt="Agon" /></Link>
									</div>
								</div >
							</div >
						</div >
								...
								<div className="row">
									<div className="col-lg-12 mt-50">
										...
										<div className="mt-100 text-center">
											<Link href="/#" className="btn btn-green-900 icon-arrow-right-white text-heading-6 color-white">Contact Us</Link>

											<Link href="/#" className="btn btn-link text-heading-6">Support Center</Link>
										</div>
									</div>
								</div>
							</div>
