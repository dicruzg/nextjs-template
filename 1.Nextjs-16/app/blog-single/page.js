                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-1 col-md-2 col-sm-2 col-3 text-center">
                                    <div className="social-sticky">
                                        ...
                                        <Link href="/https://facebook.com" className="share-social share-fb"></Link>
                                        <br />
                                        <Link href="/https://twitter.com" className="share-social share-tw"></Link>
                                        <br />
                                        <Link href="/https://www.pinterest.com" className="share-social share-pi"></Link>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8">
                                    <div className="single-detail mt-50">
                                        <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="img-responsive bdr-16" src="/assets/imgs/page/blog/single/img-1.png" alt="Agon" />
                                        <p />
                                        ...
                                        <div className="box-quote">
                                            ...
                                            <div className="box-user">
                                                <div className="img-user">
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/single/user-4.png" alt="Agon" />
                                                </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-4">
                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="img-responsive bdr-10 mt-10" src="/assets/imgs/page/blog/single/img-2.png" alt="Agon" />
                                            </div>
                                        </div>
                                        <p />
                                        ...
                                        <div className="row mt-45 mb-30">
                                            <div className="col-lg-6">
                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/blog/single/img-3.png" alt="Agon" />
                                            </div>
                                            <div className="col-lg-6">
                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="img-responsive mb-20" src="/assets/imgs/page/blog/single/img-4.png" alt="Agon" />
                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/blog/single/img-5.png" alt="Agon" />
                                            </div>
                                        ...
                                        <div>
                                            <Link href="/blog-1" className="btn btn-tag mr-10">
                                                Nature
                                            </Link>
                                            <Link href="/blog-2" className="btn btn-tag mr-10">
                                                Beauty
                                            </Link>
                                            <Link href="/blog-1" className="btn btn-tag mr-10">
                                                Travel tips
                                            </Link>
                                            <Link href="/blog-2" className="btn btn-tag">
                                                Houes
                                            </Link>
                                        </div>
                                    </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div className="item-comment">
                                                        <div className="blog-img-user">
                                                            <div className="img-user img-user-round">
                                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/single/user-1.png" alt="Agon" />
                                                            </div>
                                                ...
                                                <li>
                                                    <div className="item-comment">
                                                        <div className="blog-img-user">
                                                            <div className="img-user img-user-round">
                                                                <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/single/user-2.png" alt="Agon" />
                                                            </div>
                                                            <h4 className="text-heading-6 color-gray-900">Robert Fox</h4>
                                                            <p className="text-body-small color-gray-500">August 25, 2026</p>
                                                        </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div className="item-comment">
                                                                <div className="blog-img-user">
                                                                    <div className="img-user img-user-round">
                                                                        <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/single/user-3.png" alt="Agon" />
                                                                    </div>
                                                                    <h4 className="text-heading-6 color-gray-900">Robert Fox</h4>
                                                                    <p className="text-body-small color-gray-500">August 25, 2026</p>
                                                                </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-5 col-md-6 col-sm-7 mb-30">
                                                        <label className="box-agree">
                                                            ...
                                                            <span className="text-body-text-md color-gray-1200">Save my name, email, and website in this browser for the next time I comment.</span>
                                                        </label>
                                                    </div>
                                                    <div className="col-lg-7 col-md-6 col-sm-5 text-end">
                                                        <button className="btn btn-black shape-square btn-md text-body-text">Post comment</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
