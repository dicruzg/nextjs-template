			...
			<Layout>
					...
					<div className="banner-hero banner-3">
						<div className="container">
							<div className="text-center"><span className="tag-1 bg-6 color-green-900">Digital Marketing Agency</span>
								...
								<div className="mt-50">
									<Link href="/page-about-1" className="btn btn-black icon-arrow-right-white mb-15">Start free trial
									</Link>
									<Link href="/page-about-2" className="btn btn-default icon-arrow-right color-gray-900 ml-20 btn-mb mb-15">Learn more
									</Link>
								</div>
							</div>
						</div>
							...
							<div className="col-lg-10">
								<div className="box-image">
									...
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive bdrd-16" src="/assets/imgs/page/homepage3/img-banner-video.png" alt="Agon" /></div>
							</div>
							<div className="col-lg-1" />
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-md-12 col-sm-12">
								<div className="list-icons mt-50">
									<div className="item-icon"><span className="icon-left"><Image
										width="0"
										height="0"
										sizes="100vw"
				...
				<section className="section-box">
					<div className="container mt-120">
						<div className="row">
							<div className="col-lg-6 col-sm-12 block-img-we-do"><Image
								width="0"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage3/img-2.png" alt="Agon" /></div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-30"><span className="tag-1 bg-6 color-gray-900">Built Exclusively For You</span>
								...
								<div className="mt-40">
									<Link href="/page-contact" className="btn btn-default btn-white icon-arrow-right">Learn More
									</Link>
								</div>
							</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-40">
								...
								<div className="mt-60">
									<Link href="/page-contact" className="btn btn-black icon-arrow-right-white">Contact Us
									</Link>
									<Link href="/page-login" className="btn btn-link text-heading-6">Support Center
									</Link>
								</div>
							</div>
							<div className="col-lg-7">
								...
								<div className="card-grid-style-4"><span className="tag-dot">Company</span>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-4.png" alt="Agon" />
										</Link>
									</div>
								</div >
							</div >
								...
								<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
									...
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-5.png" alt="Agon" />
										</Link>
									</div>
								</div >
							</div >
								...
								<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
									...
									<div className="grid-4-img color-bg-4">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-6.png" alt="Agon" />
										</Link>
									</div>
								</div >
							</div >
