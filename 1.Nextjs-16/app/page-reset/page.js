                                    ...
                                    <div className="box-form-signup">
                                        <div className="form-group">
                                            <div className="form-field">
                                                <input className="form-control input-green-bd input-with-icon" placeholder="Enter your email" />
                                                <span className="icon-email-right" />
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <button className="btn btn-green-full text-heading-6">Reset password</button>
                                        </div>
                                        <div className="form-group">
                                            <Link href="/" className="text-body-text">
                                                Back to homepage
                                            </Link>
                                        </div>
                                    </div>
