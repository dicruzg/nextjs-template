			...
			<Layout>
							...
							<div className="row">
								...
								<div className="col-lg-5 d-none d-lg-block">
									<div className="banner-imgs">
										<div className="block-1 shape-1"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage6/line-chart.svg" alt="Agon" /></div>
										<div className="block-2 shape-3"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage6/card.png" alt="Agon" /></div><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-banner img-responsive shape-2" alt="Agon" src="/assets/imgs/page/homepage6/banner.png" />
									</div>
								</div>
							</div>
						</div>
							...
							<div className="box-video-homepage6">
								<div className="box-image mt-30 mb-30">
									...
									<Image
										...
										alt="Agon"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive bdrd-16" src="/assets/imgs/page/homepage6/img.png" /></div>
							</div>
							<div className="row">
								<div className="col-lg-4 col-md-12 col-sm-12">
									<div className="list-icons mt-50">
										<div className="item-icon none-bd"><span className="icon-left"><Image
											...
											alt="Agon"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage6/icon-acquis.svg" /></span>
								...
								<div className="col-lg-4 col-md-12 col-sm-12">
									<div className="list-icons mt-50">
										<div className="item-icon none-bd"><span className="icon-left"><Image
											...
											alt="Agon"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage6/icon-active.svg" /></span>
								...
								<div className="col-lg-4 col-md-12 col-sm-12">
									<div className="list-icons mt-50">
										<div className="item-icon none-bd"><span className="icon-left"><Image
											...
											alt="Agon"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage6/icon-retent.svg" /></span>
				...
				<div className="section-box">
					<div className="container mt-120">
						<div className="row">
							<div className="col-xl-5 col-lg-6 col-sm-12 mb-30"><Image
								width="0"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage6/img-1.png" alt="Agon" /></div>
					...
					<div className="container mt-100">
						<div className="row">
							...
							<div className="col-lg-4 text-lg-end text-start pt-30">
								<Link href="#" className="btn btn-black icon-arrow-right-white">View More</Link>
							</div>
						</div>
					</div>
						...
						<div className="row">
							...
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
									<Link href="#" className="text-heading-4">How To Blow Through Capital At An Incredible Rate</Link>
							...
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
									<Link href="#" className="text-heading-4">Design Studios That Everyone Should Know About?</Link>
