						...
						<div className="container">
							<div className="row">
								<div className="col-lg-7 box-banner-left">
									...
									<div className="mt-40">
										<Link href="/page-about-1" className="btn btn-black shape-square icon-arrow-right-white">Get Started</Link>

										<Link href="/page-pricing-1" className="btn btn-link icon-triangle color-gray-900 ml-40">How it works</Link>
									</div>
								...
								<div className="col-lg-5 d-none d-lg-block">
									<div className="banner-imgs">
										<div className="block-1 shape-2"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/banner-2.png" alt="Agon" /></div><Image
											width="0"
											height="0"
											sizes="100vw"
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-support.svg" alt="Agon" /></span>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-web.svg" alt="Agon" /></span>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-business.svg" alt="Agon" /></span>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-product.svg" alt="Agon" /></span>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-share.svg" alt="Agon" /></span>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-build.svg" alt="Agon" /></span>
										<h4 className="text-heading-6">Support Engineer</h4>
										<p className="text-body-text color-gray-500 mt-15">We commit to original work of the highest standard and giving credit where its due.</p>
									</div>
								</div>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-12">
								<div className="list-icons">
									<div className="item-icon none-bd"><span className="icon-left"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/services/1/icon-team.svg" alt="Agon" /></span>
										<h4 className="text-heading-6">Support Engineer</h4>
										<p className="text-body-text color-gray-500 mt-15">We commit to original work of the highest standard and giving credit where its due.</p>
									</div>
								</div>
						...
						<div className="row">
							...
							<div className="col-lg-6 col-sm-12 block-we-do">
								<div className="inner-image"><Image
									...
									<div className="block-image-bottom"><Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-built-2.png" alt="Agon" /></div>
								</div>
							</div>
						</div>
					</div>
