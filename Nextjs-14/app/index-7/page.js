			...
			<Layout>
						...
						<div className="container mt-40">
							<div className="row">
								...
								<div className="col-lg-5 offset-xl-1 mt-30">
									...
									<div className="mt-40">
										<Link href="#" className="btn btn-black shape-square icon-arrow-right-white">Get Start</Link>

										<Link href="#" className="btn btn-link icon-triangle color-gray-900 ml-40">How it works</Link>
									</div>
								</div >
							</div >
						</div >
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-7"><Image
								...
								sizes="100vw"
								alt="Agon"
								style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/banner-1.png" /></div>
							<div className="col-lg-5"><Image
								width="0"alt="Agon"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/banner-2.png" /></div>
						</div>
					</div>
				</div>
				<div className="section-box mt-100">
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-30"><span className="tag-1 bg-3 color-gray-900">Built Exclusively For You</span>
								...
								<div className="mt-40">
									<Link href="#" className="btn btn-default btn-white icon-arrow-right">Learn More</Link>
								</div>
							</div>
										...
										<div className="card-grid-style-2 card-square hover-up mb-20">
											...
											<div className="box-img-user">
												<div className="img-user img-user-round"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-1.png" alt="Agon" /></div>
										...
										<div className="card-grid-style-2 card-square hover-up mb-20">
											...
											<div className="box-img-user">
												<div className="img-user img-user-round"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-2.png" alt="Agon" /></div>
										...
										<div className="card-grid-style-2 card-square hover-up mb-20">
											...
											<div className="box-img-user">
												<div className="img-user img-user-round"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-3.png" alt="Agon" /></div>
										...
										<div className="card-grid-style-2 card-square hover-up mb-20">
											...
											<div className="box-img-user">
												<div className="img-user img-user-round"><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage2/user-4.png" alt="Agon" /></div>
				...
				<div className="section-box">
					<div className="container mt-120">
						<div className="row">
							<div className="col-lg-6 col-md-12 col-sm-12 block-img-we-do text-center"><Image
								width="0"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} className="img-small img-responsive" src="/assets/imgs/page/homepage7/img-1.png" alt="Agon" />
								<div className="block-card"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/card.png" alt="Agon" /></div>
								<div className="block-control"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/img-safety.png" alt="Agon" /></div>
							</div>
				...
				<div className="section-box mt-140">
					...
					<div className="container list-category-homepage7 mt-70">
								...
								<div className="grid-category-2">
									<div className="grid-category-image">
										<Link href="#" ><Image
											...
											height="0"alt="Agon"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/img-cat-1.png" /></Link>
									</div>
									<Link href="#" className="text-heading-5 color-gray-900">Design Studios That Everyone Should Know About?</Link>

									<div className="category-info-bottom">
										<div className="link-category">
											<Link href="#" className="mr-20">Building</Link>
								...
								<div className="grid-category-2">
									<div className="grid-category-image">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/img-cat-2.png" /></Link>
									</div>
									<Link href="#" className="text-heading-5 color-gray-900">Design Studios That Everyone Should Know About?</Link>
								...
								<div className="grid-category-2">
									<div className="grid-category-image">
										<Link href="#" ><Image
											...
											height="0"alt="Agon"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/img-cat-3.png" /></Link>
									</div>
									<Link href="#" className="text-heading-5 color-gray-900">Design Studios That Everyone Should Know About?</Link>
								...
								<div className="grid-category-2">
									<div className="grid-category-image">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage7/img-cat-4.png" /></Link>
									</div>
									<Link href="#" className="text-heading-5 color-gray-900">Design Studios That Everyone Should Know About?</Link>
						...
						<div className="text-center mt-30">
							<Link href="#" className="btn btn-black icon-arrow-right-white">Load more resource</Link>
						</div >
					</div >
				</div >
				<div className="section-box">
								...
								<div className="card-grid-style-4">
									<div className="grid-4-img mb-20">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-1.png" alt="Agon" /></Link>
									</div>
								...
								<div className="card-grid-style-4">
									<div className="grid-4-img color-bg-2 mb-20">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-2.png" alt="Agon" /></Link>
									</div>
									<Link href="#" className="text-heading-4">We can blend colors multiple ways, the most common</Link>
								...
								<div className="card-list-style-1">
									...
									<div className="style-1-img color-bg-10">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-news-1.png" alt="Agon" /></Link>
									</div>
								</div >
								<div className="card-list-style-1">
									<Link href="#" className="text-heading-6">Design Studios That Everyone Should Know About?</Link>
									...
									<div className="row">
										<div className="col-lg-5 col-md-7"><span className="text-body-capitalized color-gray-500 text-uppercase">newsletter</span>
											...
											<div className="box-form-newsletter mt-30">
												<form className="form-newsletter"><input className="input-newsletter" placeholder="Enter you mail .." /><button className="btn btn-send"></button></form>
											</div>
										</div>
										<div className="col-lg-7 col-md-5 mt-30 mt-lg-0 mt-md-30 mt-sm-30 position-relative text-end">
											<div className="block-chart"><Image
												width="0"
												height="0"
												sizes="100vw"
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="img-responsive img-newsletter" src="/assets/imgs/page/homepage2/img-newsletter.png" alt="Agon" />
										</div>
									</div>
								</div>
							</div>
