						...
						<div className="container">
							<div className="row">
								<div className="col-lg-7">
									...
									<div className="mt-40">
										<Link href="/page-service-1" className="btn btn-black icon-arrow-right-white">Get Start</Link>
										<Link href="/page-about-1" className="btn btn-link icon-arrow-right color-gray-900 text-heading-6">Learn More</Link>
									</div>
								</div>
								<div className="col-lg-5 d-none d-lg-block">
									<div className="banner-imgs">
										...
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-responsive shape-2" alt="Agon" src="/assets/imgs/page/homepage1/banner.png" />
									</div>
								</div>
							</div>
						</div>
					...
					<div className="container">
						<div className="row justify-content-md-center">
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-1.svg" /></Link>
							</div>
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-2.svg" /></Link>
							</div>
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-3.svg" /></Link>
							</div>
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-4.svg" /></Link>
							</div >
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-5.svg" /></Link>
							</div >
							<div className="col-lg-2 col-md-3 col-sm-4 col-6 text-center">
								<Link href="/#" className="item-logo box-hover-shadow hover-up"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-6.svg" /></Link>
							</div >
						</div >
					</div >
				</div >
									...
									<div className="row">
										<div className="col-lg-6 col-md-12">
											<div className="box-optimized">
												...
												<div className="mt-40">
													<Link href="/page-service-1" className="btn btn-default btn-white icon-arrow-right">Learn more</Link>
												</div>
											</div>
										</div>
										<div className="col-lg-6 col-md-12">
											<div className="block-video icon-pattern">
												...
												<Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1.png" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
							...
							<div className={activeIndex === 2 ? "tab-pane fade  active show" : "tab-pane fade "}>
								<div className="bg-1 panel-box mt-50">
									<div className="row">
										...
										<div className="col-lg-6 col-sm-12">
											<div className="block-video icon-pattern">
												<a className="popup-youtube btn-play-video" onClick={openModal}></a><Image
													width="0"
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1-2.jpg" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
										...
										<div className="col-lg-6 col-sm-12">
											<div className="block-video icon-pattern">
												<a className="popup-youtube btn-play-video" onClick={openModal}></a><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1-3.jpg" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
										...
										<div className="col-lg-6 col-sm-12">
											<div className="block-video icon-pattern">
												<a className="popup-youtube btn-play-video" onClick={openModal}></a><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1-4.jpg" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
										...
										<div className="col-lg-6 col-sm-12">
											<div className="block-video icon-pattern">
												<a className="popup-youtube btn-play-video" onClick={openModal}></a><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1-5.jpg" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
										...
										<div className="col-lg-6 col-sm-12">
											<div className="block-video icon-pattern">
												<a className="popup-youtube btn-play-video" onClick={openModal}></a><Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/homepage1/img-1-6.jpg" alt="Agon" />
											</div>
										</div>
									</div>
								</div>
								...
								<div className="card-grid-1 bg-5 bg-business hover-up">
									<div className="grid-1-img">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/business-strategy.svg" alt="Agon" />
									</div>
									...
									<div className="mt-30">
										<Link href="/page-about-1" className="btn btn-default btn-white icon-arrow-right">Learn more</Link>
									</div>
								</div>
							</div>
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-1 bg-9 bg-local hover-up">
									<div className="grid-1-img">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/local.svg" alt="Agon" />
									</div>
									<h3 className="text-heading-3 mt-20">
										Local Marketing
									</h3>
									...
									<div className="mt-30">
										<Link href="/page-about-2" className="btn btn-default btn-white icon-arrow-right">Learn more</Link>
									</div>
								</div>
							</div>
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-1 bg-2 bg-social hover-up">
									<div className="grid-1-img">
										<Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/social.svg" alt="Agon" />
									</div>
									<h3 className="text-heading-3 mt-20">
										Social media
									</h3>
									...
									<div className="mt-30">
										<Link href="/page-about-3" className="btn btn-default btn-white icon-arrow-right">Learn more</Link>
									</div>
								</div>
							</div>
						</div >
						...
						<div className="row">
							<div className="col-lg-6 col-sm-12 block-img-we-do">
								<Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage1/img-2.png" alt="Agon" />
							</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-lg-4 text-lg-end text-start pt-30">
								<Link href="/blog-1" className="btn btn-black icon-arrow-right-white">View More</Link>
							</div>
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4">
									<span className="tag-dot">Company</span><Link href="/blog-single" className="text-heading-4">We can blend colors multiple ways, the most
										common</Link>
									<div className="grid-4-img">
										<Link href="/blog-single" legacyBehavior>
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-1.png" alt="Agon" />
										</Link>
									</div>
								</div>
							</div>
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4">
									<span className="tag-dot">Marketing Event</span><Link href="/blog-single" className="text-heading-4">How To Blow Through Capital At An
										Incredible Rate</Link>
									<div className="grid-4-img">
										<Link href="/blog-single" ><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-2.png" alt="Agon" /></Link>
									</div>
								</div>
							</div >
							<div className="col-lg-4 col-sm-12 pr-30">
								<div className="card-grid-style-4">
									<span className="tag-dot">Customer Services</span><Link href="/blog-single" className="text-heading-4">Design Studios That Everyone Should Know
										About?</Link>
									<div className="grid-4-img color-bg-4">
										<Link href="/blog-single" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-3.png" alt="Agon" /></Link>
									</div>
								</div >
							</div >
						</div >
										...
										<div className="col-lg-7 col-md-5 mt-30 mt-lg-0 mt-md-30 mt-sm-30 position-relative text-end">
											<div className="block-chart shape-1">
												<Image
													...
													height="0"
													sizes="100vw"
													style={{ width: "auto", height: "auto" }} src="/assets/imgs/template/chart.png" alt="Agon" />
											</div>
											<Image
												width="0"
												height="0"
