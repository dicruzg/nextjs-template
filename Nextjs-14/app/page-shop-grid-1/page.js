					...
					<div className="container">
						...
						<div className="row">
							...
							<div className="col-lg-6 text-end">
								<Link href="/page-signup" className="btn btn-default hover-up icon-arrow-right mt-10">Browse All</Link>
							</div>
						</div>
					</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/pc.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/headphone.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/laptop.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mobile.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/printer.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/book.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/tablet.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/usb.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mouse.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/security.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/watch.svg" alt="agon" /></Link>
									</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/scan.svg" alt="agon" /></Link>
									</div>
								...
								<div className="icon-layout mr-10 text-body-text color-gray-500">Show:<div className="color-green-900 d-inline">
									<div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>50</span><i className="fi-rr-angle-small-down"></i></button>
										<ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage">
											<li>
												<Link href="#" className="dropdown-item active">50</Link>
											</li>
											<li>
												<Link href="#" className="dropdown-item">100</Link>
											</li>
											<li>
												<Link href="#" className="dropdown-item">150</Link>
											</li>
										</ul>
									</div>
								</div>
								...
								<div className="icon-sort text-body-text color-gray-500">Sort by:<div className="color-green-900 d-inline">
									<div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownSort" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>Featured</span><i className="fi-rr-angle-small-down"></i></button>
										<ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownSort">
											<li>
												<Link href="#" className="dropdown-item active">Featured</Link>
											</li>
											<li>
												<Link href="#" className="dropdown-item">Rating</Link>
											</li>
											<li>
												<Link href="#" className="dropdown-item">Low Price</Link>
											</li>
										</ul>
									</div>
								</div >
										...
										<div className="product-item-2 hover-up">
											<Link href={`/shop/${item.id}`} legacyBehavior>
												...
												<div className="product-image">
													<Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} className="img-fluid" src={`/assets/imgs/page/homepage5/${item.img}`} alt="" />
												</div>
											</Link>
											...
											<div className="product-info"><span className="text-body-small color-gray-500 font-bold">{item.brand}</span>
												...
												<div className="rating mt-10">
													<div className="box-rating"><span></span><Image
														width="0"
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /><span></span><Image
															width="0"
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /><span></span><Image
															...
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star.svg" alt="agon" /></div><span className="text-semibold"><span>(</span><span>{item.rating}</span><span>&nbsp;rates )</span></span>
												</div>
												<div className="d-flex mt-20">
													...
													<div className="button-add text-end">
														<Link href="#" className="btn btn-cart">Add</Link>
													</div>
												</div>
											</div >
										</div >
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp1.png" alt="agon" /></div>
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp2.png" alt="agon" /></div>
										<div className="product-info">
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp3.png" alt="agon" /></div>
										<div className="product-info">
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp4.png" alt="agon" /></div>
										<div className="product-info">
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp5.png" alt="agon" /></div>
										<div className="product-info">
								...
								<div className="product-item-1 hover-up">
									<Link href="#" >
										<div className="product-image"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp6.png" alt="agon" /></div>
										<div className="product-info">
						...
						<div className="row">
								...
								<div className="card-grid-style-4">
									<div className="grid-4-img color-bg-9 mb-20">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img.png" alt="Agon" /></Link>
									</div>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-1.png" alt="Agon" /></div>
								...
								<div className="card-grid-style-4">
									<div className="grid-4-img color-bg-2 mb-20">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-2.png" alt="Agon" /></Link>
									</div>
									<Link href="#" className="text-heading-4">We can blend colors multiple ways, the most common</Link>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-2.png" alt="Agon" /></div>
										<h4 className="text-heading-6 color-gray-900">Jenny Wilson</h4>
										<p className="text-body-small color-gray-500">August 25, 2022</p>
									</div>
								</div>
							...
							<div className="col-lg-4 col-sm-12 pr-30 mb-50">
								<div className="card-list-style-1">
									<Link href="#" className="text-heading-6">Design Studios That Everyone Should Know About?</Link>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-3.png" alt="Agon" /></div>
									...
									<div className="style-1-img color-bg-10">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-3.png" alt="Agon" /></Link>
									</div>
								</div >
								<div className="card-list-style-1">
									<Link href="#" className="text-heading-6">Design Studios That Everyone Should Know About?</Link>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-4.png" alt="Agon" /></div>
									...
									<div className="style-1-img color-bg-2">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-4.png" alt="Agon" /></Link>
									</div >
								</div >
								<div className="card-list-style-1">
									<Link href="#" className="text-heading-6">Design Studios That Everyone Should Know About?</Link>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-5.png" alt="Agon" /></div>
									...
									<div className="style-1-img color-bg-5">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-5.png" alt="Agon" /></Link>
									</div >
								</div >
								<div className="card-list-style-1">
									<Link href="#" className="text-heading-6">Design Studios That Everyone Should Know About?</Link>
									...
									<div className="blog-img-user">
										<div className="img-user img-user-round"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/user-6.png" alt="Agon" /></div>
									...
									<div className="style-1-img color-bg-9">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/img-6.png" alt="Agon" /></Link>
									</div >
								</div >
							</div >
						</div >
				...
				<section className="section-box mt-70 shop-bottom-banner">
					<div className="container">
						<div className="box-green box-green-2 bdr-18">
							...
							<div className="mt-60">
								<Link href="#" className="mr-20"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/apple-button.svg" alt="agon" /></Link>

								<Link href="#" ><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" alt="agon" /></Link>
							</div>
							...
							<div className="block-1 d-none d-lg-block"><Image
								width="0"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/safety.png" alt="agon" /></div>
							<div className="block-2 d-none d-lg-block"><Image
								width="0"
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/chart.png" alt="agon" /></div>
						</div>
					</div >
				</section >
			</Layout >
