				...
				<section className="section-box">
					<div className="bg-2-opacity-80">
						<div className="box-login">
							<div className="row">
								<div className="col-xxl-7 col-xl-6 col-lg-6 col-md-12 login-left pl-0 d-none d-lg-flex"><Image
									width="0"
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} className="img-responsive" src="/assets/imgs/page/login/img-1.png" alt="Agon" /></div>
									...
									<div className="box-login-form">
										<div className="box-signup mt-90">
											...
											<Link href="/#" className="btn btn-login-google color-gray-500 text-heading-6 box-shadow-2"><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} className="img-responsive img-middle mr-10" src="/assets/imgs/template/icons/Icon-gg-login.svg" alt="Agon" /> Sign in with Google</Link>
											...
											<div className="box-form-signup">
												...
												<div className="form-group">
													<Link href="/page-reset" className="text-body-text">Forgot password?</Link>
												</div>
												...
												<div><span className="text-body-text color-gray-500">Don’t have an account?</span>
													<Link href="/page-signup" className="text-body-text color-green-900">Sign up</Link>
												</div>
											</div>
										</div>
									</div>
