								...
								<div className="row">
									<div className="col-lg-2">
										<div className="table-of-content">
											...
											<ul>
												<li>
													<Link href="#section-1" >Limitation of Liability</Link>
												</li>
												<li>
													<Link href="#section-2" >Licensing Policy</Link>
												</li>
												<li>
													<Link href="#section-3" >Product Compatibility</Link>
												</li>
												<li>
													<Link href="#section-4" >Delivery</Link>
												</li>
												<li>
													<Link href="#section-5" >Ownership</Link>
												</li>
												<li>
													<Link href="#section-6" >Browser Compatibility</Link>
												</li>
												<li>
													<Link href="#section-7" >Updates</Link>
												</li>
												<li>
													<Link href="#section-8" >Template Support</Link>
												</li>
												<li>
													<Link href="#section-9" >Price Changes</Link>
												</li>
												<li>
													<Link href="#section-10" >Refund Policy</Link>
												</li>
												<li>
													<Link href="#section-11" >Email and Newsletter</Link>
												</li>
												<li>
													<Link href="#section-12" >License Agreement</Link>
												</li>
												<li>
													<Link href="#section-13" >Severability</Link>
												</li>
											</ul>
										</div>
									</div>
