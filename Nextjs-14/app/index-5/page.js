								...
								<div className="col-lg-8"><span className="text-heading-4 color-gray-400">Exclusive Smart Watch</span>
									...
									<div className="mt-40 box-mw-610">
										<div className="form-newsletter-2">
											<form><input className="input-newsletter"  placeholder="Enter your email ..." /><button className="btn btn-newsletter icon-arrow-right-white" type="submit">Joint Pre-Order</button></form>
										</div>
									</div>
								</div>
									...
									<div className="banner-imgs">
										<div className="block-1 shape-2">
											<Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/circle-1.svg" alt="Agon" /></div>
										<div className="block-2 shape-3">
											<Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/circle-2.svg" alt="Agon" /></div>
										<div className="block-3 shape-3">
											<Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/card.png" alt="Agon" />
										</div>
										<Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-responsive shape-1" alt="Agon" src="/assets/imgs/page/homepage5/banner.png" />
									</div>
								</div>
							</div>
						</div>
								...
								<div className="product-item-1 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
									<Link href="#" >
										<div className="product-image"><Image
											...
											sizes="100vw"
											alt="Agon"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp1.png" /></div>
								...
								<div className="product-item-1 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
									<Link href="#" >
										<div className="product-image"><Image
											...
											sizes="100vw"
											alt="Agon"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp2.png" /></div>
										<div className="product-info">
								...
								<div className="product-item-1 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
									<Link href="#" >
										<div className="product-image"><Image
											...
											sizes="100vw"
											alt="Agon"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp3.png" /></div>
										<div className="product-info">
							...
							<div className="col-xl-5 col-lg-5 col-md-12 col-sm-12">
								<div className="list-categories-number box-bdr-2 mb-30">
									...
									<ul className="list-category">
										...
										<li>
											<Link href="#" >Smart phone and Tablets</Link>
											<span className="number">12</span></li>
										<li>
											<Link href="#" >Fashion and Accessories</Link>
								...
								<ul className="list-steps">
									<li className="icon-asset1">
										<div className="text-center block-step bg-9 hover-up">
											...
											alt="Agon"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-start-plan.svg" /></div>
									...
									<li className="icon-asset2">
										<div className="text-center block-step hover-up">
											...
											alt="Agon"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-connect.svg" /></div>
									...
									<li className="icon-asset3">
										<div className="text-center block-step bg-5 hover-up">
											...
											alt="Agon"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-match.svg" /></div>
									...
									<li className="icon-asset4">
										<div className="text-center block-step bg-5 hover-up">
											...
											alt="Agon"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-complete.svg" /></div>
									...
									<li>
										<div className="text-center block-step bg-9 hover-up">
											...
											alt="Agon"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/2/icon-review.svg" /></div>
						...
						<div className="box-green br-16">
							...
							<div className="mt-60">
								<Link href="#" className="mr-20"><Image
									...
									sizes="100vw"
											alt="Agon"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/apple-button.svg" /></Link>
								...
								<Link href="#" ><Image
									...
									height="0"
											alt="Agon"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" /></Link>
							</div>
								...
								<ul className="list-partners none-bd pb-0">
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/agon.svg" /></Link>
									</li>
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/monst.svg" /></Link>
									</li>
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/figwire.svg" /></Link>
									</li>
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/evara.svg" /></Link>
									</li>
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/frox.svg" /></Link>
									</li>
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/alithemes.svg" /></Link>
									</li >
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/nestmask.svg" /></Link>
									</li >
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/theflow.svg" /></Link>
									</li >
									<li>
										<Link href="#" className="item-logo box-hover-shadow hover-up"><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} alt="Agon" src="/assets/imgs/page/homepage5/stacker.svg" /></Link>
									</li >
								</ul >
							</div >
						</div >
