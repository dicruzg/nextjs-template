								...
								<nav>
									<ul className="mobile-menu font-heading">
										...
										<li className={isActive.key == 6 ? "has-children active" : "has-children"}>
											...
											<Link href="/page-shop-grid-1" >Shop</Link>
											<ul className={isActive.key == 6 ? "sub-menu d-block" : "sub-menu d-none"}>
												<li>
													<Link href="/page-shop-grid-1" className="closer">Shop Grid - 1</Link>
												</li>
												<li>
													<Link href="/page-shop-grid-2" className="closer">Shop Grid - 2</Link>
												</li >
												<li>
													<Link href="/shop/1" >Product Details</Link>
												</li >
											</ul >
										</li >
									</ul >
