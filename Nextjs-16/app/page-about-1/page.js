						...
						<div className="container">
							<div className="row">
								<div className="col-lg-7"><span className="tag-1 color-orange-900">What We Do, What You Get</span>
									...
									<div className="mt-40">
										<Link href="/page-service-1" className="btn btn-black shape-square icon-arrow-right-white">Join Our Team
										</Link>

										<Link href="/page-contact" className="btn btn-link color-gray-900 icon-arrow-right text-heading-6">Contact Us
										</Link>
									</div>
								</div>
								<div className="col-lg-5 d-none d-lg-block">
									<div className="banner-imgs">
										<div className="block-1 shape-1"><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/about/1/banner2.png" alt="Agon" /></div><Image
											width="0"
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} className="img-responsive shape-2" alt="Agon" src="/assets/imgs/page/about/1/banner1.png" />
									</div>
								</div>
							</div>
						</div>
							...
							<div className="col-lg-10">
								<div className="box-image">
									...
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive bdrd-16" src="/assets/imgs/page/about/1/img-1.png" alt="Agon" /></div>
							</div>
							<div className="col-lg-1" />
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-style-3 pb-40 bg-5 mb-30">
									...
									<div className="mt-30">
										<Link href="/page-service-1" className="btn btn-default icon-arrow-right">Learn more
										</Link>
									</div>
								</div>
							</div>
