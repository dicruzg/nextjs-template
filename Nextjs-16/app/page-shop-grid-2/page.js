                                    ...
                                    <ul className="list-products-sidebar">
                                        <li>
                                            <div className="product-item-2 product-item-4">
                                                <div className="product-image">
                                                    <Link href="#">
                                                        <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/sp5.png" alt="agon" />
                                                    </Link>
                                                </div>
                                                <div className="product-info">
                                                    <Link href="#">
                                        ...
                                        <li>
                                            <div className="product-item-2 product-item-4">
                                                <div className="product-image">
                                                    <Link href="#">
                                                        <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/sp4.png" alt="agon" />
                                                    </Link>
                                                </div>
                                                <div className="product-info">
                                                    <Link href="#">
                            ...
                            <div className="sidebar sidebar-gray">
                                ...
                                <div className="widget-content">
                                    ...
                                    <form className="form-newletters mt-15" action="#">
                                        ...
                                        <input className="btn btn-green-900 btn-green-small mt-20" type="submit" value="Submit" />
                                    </form>
                                </div>
                            </div>
                        </div>
