					...
					<div className="banner-hero banner-3">
						<div className="container">
							<div className="text-center"><span className="tag-1 bg-6 color-green-900">Success Together</span>
								...
								<div className="mt-50">
									<Link href="/page-about-3" className="btn btn-black icon-arrow-right-white mb-15 mr-20">Join our team</Link>

									<Link href="/page-faqs-1" className="btn btn-default icon-arrow-right color-gray-900 btn-mb mb-15">Learn more</Link>
								</div>
							</div>
						</div>
					</div>
							...
							<div className="col-lg-10">
								<div className="box-image">
									...
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive bdrd-16" src="/assets/imgs/page/career/img.png" alt="Agon" /></div>
							</div>
							<div className="col-lg-1" />
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-1 bg-5 hover-up">
									<div className="grid-1-img"><Image
										width="0"
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/business-strategy.svg" alt="Agon" /></div>
							...
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-1 bg-9 hover-up">
									<div className="grid-1-img"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/local.svg" alt="Agon" /></div>
							...
							<div className="col-lg-4 col-sm-12">
								<div className="card-grid-1 bg-2 hover-up">
									<div className="grid-1-img"><Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/social.svg" alt="Agon" /></div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-30"><span className="tag-1 bg-6 color-gray-900">Built Exclusively For You</span>
								...
								<div className="mt-40">
									<Link href="/page-service-1" className="btn btn-default btn-white icon-arrow-right text-body-text">Learn More</Link>
								</div>
							</div>
					...
					<div className="container mt-110">
						<div className="row">
							...
							<div className="col-lg-4 text-lg-end text-start pt-30">
								<Link href="/blog-2" className="btn btn-black icon-arrow-right-white">View More</Link>
							</div>
						</div>
					</div>
