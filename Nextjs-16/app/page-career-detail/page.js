								...
								<div className="col-lg-12">
									...
									<div className="breadcrumbs">
										<ul className="text-body-text">
											<li>
												<Link href="/#" className="color-gray-900">Home</Link>
											</li>
							...
							<div className="row">
								...
								<div className="col-lg-8">
									...
									<div className="media-block">
										<Link href="/page-signup" className="btn btn-green-900 color-white text-heading-6 icon-arrow-right-white mr-20" >Apply Now</Link>

										<Link href="/page-contact" className="btn btn-default icon-arrow-right">Contact Us</Link>

										<div className="float-start float-lg-end mt-30">
											<Link href="/#" className="btn btn-media mr-10"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/template/icons/facebook-share.svg" alt="Agon" /> Share</Link>

											<Link href="/#" className="btn btn-media mr-10"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/template/icons/twitter-share.svg" alt="Agon" /> Tweet</Link>

											<Link href="/#" className="btn btn-media"><Image
												width="0"
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/template/icons/pinterest-share.svg" alt="Agon" /> Pin</Link>
										</div>
									</div>
								</div >
							</div >
					...
					modal ? (
						<section className="modal__bg" onClick={openModal}>
							<div className="modal__align">
								<div className="modal__content" data-modal={modal}>
