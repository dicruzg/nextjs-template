							...
							<div className="col-lg-10">
								<div className="box-image">
									...
									<Image
										...
										height="0"
										sizes="100vw"
										style={{ width: "auto", height: "auto" }} className="img-responsive bdrd-16" src="/assets/imgs/page/about/3/img.png" alt="Agon" /></div>
							</div>
							<div className="col-lg-1" />
						</div>
					</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-5 mb-30"><span className="tag-1 color-gray-900">Built Exclusively For You</span>
								...
								<div className="mt-40">
									<Link href="/page-service-2" className="btn btn-default btn-white icon-arrow-right">Learn More</Link>
								</div>
							</div>
					...
					<div className="container mt-120">
						<div className="row">
							<div className="col-lg-6 col-sm-12 block-img-we-do"><Image
								...
								height="0"
								sizes="100vw"
								style={{ width: "auto", height: "auto" }} className="bdrd-16 img-responsive" src="/assets/imgs/page/about/3/img-2.png" alt="Agon" /></div>
