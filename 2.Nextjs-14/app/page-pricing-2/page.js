						...
						<div className="row">
							...
							<div className="col-lg-10">
								...
								<div className="text-center mt-30 mb-100">
									<Link href="/#" className="btn btn-black icon-arrow-right-white mb-20 mr-20">Start free trial</Link>

									<Link href="/#" className="btn btn-default icon-arrow-right mb-20">View plans comparison</Link>
								</div>
								<div className="row">
