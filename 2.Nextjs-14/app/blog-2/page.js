							...
							<div className="row">
									...
									<div className="card-grid-style-4">
										<div className="grid-4-img mb-20">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-1.png" alt="Agon" />
											</Link>
										</div>
									...
									<div className="card-grid-style-4">
										<div className="grid-4-img color-bg-2 mb-20">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-2.png" alt="Agon" />
											</Link>
										</div>
										<Link href="/blog-single" className="text-heading-4">We can blend colors multiple ways, the most common
										</Link>
								...
								<div className="col-lg-4 col-sm-12 pr-30 mb-50">
									<div className="card-list-style-1">
										<Link href="/blog-single" className="text-heading-6">Design Studios That Everyone Should Know About?
										</Link>
										...
										<div className="style-1-img color-bg-10">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/blog/2/img-news-1.png" alt="Agon" />
											</Link>
										</div>
									</div >
									<div className="card-list-style-1">
					...
					<section className="section-box">
						...
						<div className="container mt-90">
									...
									<div className="card-grid-style-4"><span className="tag-dot">Company</span>
										...
										<div className="grid-4-img color-bg-2">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-7.png" alt="Agon" />
											</Link>
										</div>
									</div >
								</div >
									...
									<div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
										...
										<div className="grid-4-img color-bg-8">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-8.png" alt="Agon" />
											</Link>
										</div>
									</div >
								</div >
									...
									<div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
										...
										<div className="grid-4-img color-bg-1">
											<Link href="/blog-single" ><Image
												...
												height="0"
												sizes="100vw"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage1/img-news-9.png" alt="Agon" />
											</Link>
										</div>
									</div >
								</div >
							...
							<div className="mt-20 mb-30 text-center">
								<Link href="/blog-1" className="btn btn-black icon-arrow-right-white">Load more posts
								</Link>
							</div >
						</div >
					</section >
