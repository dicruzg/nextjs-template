					...
					<div className="row dr-rtl">
						<div className="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 dr-ltr">
									...
									<div className="icon-layout mr-10 text-body-text color-gray-500">Show:<div className="color-green-900 d-inline">
										<div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>50</span><i className="fi-rr-angle-small-down"></i></button>
											<ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage">
												<li>
													<Link href="#" className="dropdown-item active">50</Link></li>
												<li>
													<Link href="#" className="dropdown-item">100</Link></li>
												<li>
													<Link href="#" className="dropdown-item">150</Link></li>
											</ul>
										</div>
									</div>
									</div>
									<div className="icon-sort text-body-text color-gray-500">Sort by:<div className="color-green-900 d-inline">
										<div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownSort" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>Featured</span><i className="fi-rr-angle-small-down"></i></button>
											<ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownSort">
												<li>
													<Link href="#" className="dropdown-item active">Featured</Link></li>
												<li>
													<Link href="#" className="dropdown-item">Rating</Link></li>
												<li>
													<Link href="#" className="dropdown-item">Low Price</Link></li>
											</ul>
										</div>
									</div>
									</div>
							...
							<div className="paginations">
								<ul className="pager">
									<li>
										<Link href="#" className="prev-page"></Link></li>
									<li>
										<Link href="#" >1</Link></li>
									<li>
										<Link href="#" >2</Link></li >
									<li>
										<Link href="#" >3</Link></li >
									<li>
										<Link href="#" className="page-dotted"></Link></li >
									<li>
										<Link href="#" className="next-page"></Link></li >
								</ul >
							</div >
						</div >
						<div className="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 dr-ltr">
							<div className="sidebar">
								...
								<div className="widget-content">
									<div className="mt-30"><span className="color-gray-500 d-inline-block mr-5">Price Range:</span><span className="text-heading-5 color-green-900 d-inline-block"><span id="price-from">$16</span> - <span id="price-to">$173</span></span><input className="form-control min-value" type="hidden" name="min-value" /><input className="form-control max-value" type="hidden" name="max-value" /></div>
									...
									<div className="mt-0">
										<Link href="#" className="btn btn-filter">Filter</Link></div>
								</div>
							</div>
							<div className="sidebar">
								<div className="widget-title">
											...
											<div className="product-item-2 product-item-4">
												<div className="product-image">
													<Link href="#" ><Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/sp5.png" alt="agon" /></Link></div>
												<div className="product-info">
													<Link href="#" >
														<h3 className="text-heading-7 color-gray-900">HP 232v Printers</h3>
													</Link>
													<div className="rating mt-5">
														<div className="box-rating"><span><Image
															width="0"
															height="0"
															sizes="100vw"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /></span><span><Image
																...
																style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /></span><span><Image
																	...
																	style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /></span><span><Image
																		...
																		style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" /></span><span><Image
																			...
																			height="0"
																			sizes="100vw"
																			style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star.svg" alt="agon" /></span></div>
														<Link href="#" className="text-semibold">(84 rates)</Link>
											...
											<div className="product-item-2 product-item-4">
												<div className="product-image">
													<Link href="#" ><Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp1.png" alt="agon" /></Link></div>
												<div className="product-info">
													<Link href="#" >
											...
											<div className="product-item-2 product-item-4">
												<div className="product-image">
													<Link href="#" ><Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp2.png" alt="agon" /></Link></div>
												<div className="product-info">
													<Link href="#" >
														<h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
													</Link>
											...
											<div className="product-item-2 product-item-4">
												<div className="product-image">
													<Link href="#" ><Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp3.png" alt="agon" /></Link></div>
												<div className="product-info">
													<Link href="#" >
														<h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
													</Link>
											...
											<div className="product-item-2 product-item-4">
												<div className="product-image">
													<Link href="#" ><Image
														...
														height="0"
														sizes="100vw"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/sp4.png" alt="agon" /></Link></div>
												<div className="product-info">
													<Link href="#" >
														<h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
													</Link>
					...
					<div className="container">
						...
						<div className="row">
							...
							<div className="col-lg-6 text-end">
								<Link href="/page-signup" className="btn btn-default hover-up icon-arrow-right mt-10">Browse All</Link></div>
						</div>
					</div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/pc.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/headphone.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/laptop.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mobile.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/printer.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/book.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/tablet.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/usb.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/mouse.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/security.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/watch.svg" alt="agon" /></Link></div>
								...
								<div className="category-grid-3 hover-up">
									<div className="category-img">
										<Link href="#" ><Image
											...
											height="0"
											sizes="100vw"
											style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/scan.svg" alt="agon" /></Link></div>
						...
						<div className="box-green box-green-2 bdr-18">
							...
							<div className="mt-60">
								...
								<Link href="#" ><Image
									...
									height="0"
									sizes="100vw"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" alt="agon" /></Link></div>
