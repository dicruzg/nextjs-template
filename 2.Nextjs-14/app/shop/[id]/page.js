										...
										<div className="product-info">
											<div className="d-flex">
												...
												<div className="box-rate-product">
													<div className="box-rating"><span>
														<Image
															width="0"
															height="0"
															sizes="100vw"
															alt="agon"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" />
													</span><span>
															<Image
																width="0"
																height="0"
																sizes="100vw"
																alt="agon"
																style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star-active.svg" /></span><span>
															<Image
																width="0"
																height="0"
																sizes="100vw"
															...
															<Image
																...
																sizes="100vw"
																alt="agon"
																style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/star.svg" /></span></div><span className="text-semibold"><span>(</span><span>{singleStore.rating}</span><span>&nbsp;rates )</span></span>
												</div>
											</div>
											...
											<div className="detail-extralink mb-30">
												...
												<div className="product-extra-link2"><button className="button button-add-to-cart" type="submit">
													<Image
														width="0"
														height="0"
														sizes="100vw"
														alt="agon"
														style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/cart.svg" /> Add to cart</button>
													<Link href="#" legacyBehavior><a className="action-btn hover-up" aria-label="Add To Wishlist">
														<Image
															width="0"
															height="0"
															sizes="100vw"
															alt="agon"
															style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/heart.svg" /></a></Link>
													...
													<div className={activeIndex === 3 ? "tab-pane fade active show" : "tab-pane fade"}>
														<div className="vendor-logo d-flex mb-30">
															<Image
																...
																sizes="100vw"
																alt="agon"
																style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/vendor-18.svg" />
														...
														<ul className="contact-infor mb-50">
															<li>
																<Image
																	...
																	sizes="100vw"
																	alt="agon"
																	style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/icon-location.svg" /><strong>Address: </strong><span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span></li>
															<li>
																<Image
																	width="0"
																	height="0"
																	sizes="100vw"
																	alt="agon"
																	style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/icon-contact.svg" /><strong>Contact Seller:</strong><span>(+91) - 540-025-553</span></li>
														</ul>
																			...
																			<div className="user justify-content-between d-flex">
																				<div className="thumb text-center">
																					<Image
																						...
																						sizes="100vw"
																						alt="agon"
																						style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-2.png" />
																			...
																			<div className="user justify-content-between d-flex">
																				<div className="thumb text-center">
																					<Image
																						...
																						sizes="100vw"
																						alt="agon"
																						style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-3.png" />
																			...
																			<div className="user justify-content-between d-flex">
																				<div className="thumb text-center">
																					<Image
																						...
																						sizes="100vw"
																						alt="agon"
																						style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/single-product/author-4.png" />
									...
									<Link href="#" legacyBehavior><a>
										<div className="product-image">
											<Image
												...
												sizes="100vw"
												alt="agon"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp4.png" /></div>
										<div className="product-info">
									...
									<Link href="#" legacyBehavior><a>
										<div className="product-image">
											<Image
												...
												sizes="100vw"
												alt="agon"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp5.png" /></div>
										<div className="product-info">
									...
									<Link href="#" legacyBehavior><a>
										<div className="product-image">
											<Image
												...
												sizes="100vw"
												alt="agon"
												style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/sp6.png" /></div>
										<div className="product-info">
				...
				<section className="section-box mt-70 shop-bottom-banner">
					<div className="container">
						<div className="box-green box-green-2 bdr-18">
							...
							<div className="mt-60">
								<Link href="#" legacyBehavior><a className="mr-20">
									<Image
										width="0"
										height="0"
										sizes="100vw"
										alt="agon"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/apple-button.svg" /></a></Link>
								<Link href="#" legacyBehavior><a>
									<Image
										width="0"
										height="0"
										sizes="100vw"
										alt="agon"
										style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/homepage5/google-play.svg" /></a></Link></div>
							...
							<div className="block-1 d-none d-lg-block">
								<Image
									...
									sizes="100vw"
									alt="agon"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/safety.png" /></div>
							<div className="block-2 d-none d-lg-block">
								<Image
									...
									sizes="100vw"
									alt="agon"
									style={{ width: "auto", height: "auto" }} src="/assets/imgs/page/shop1/chart.png" /></div>
						</div>
					</div>
				</section>
